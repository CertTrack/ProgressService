...
public class KafkaProducerConfig {
    ...
    public Map<String, Object> producerConfig() {
        ...
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class); // Використовуємо JsonSerializer для мап
        return props;
    }
    ...
    public KafkaTemplate<String, Map<String, String>> kafkaTemplate(
                    ProducerFactory<String, Map<String, String>> producerFactory) {
