...
public class SwaggerConf {
	...
	public OpenAPI customOpenAPI() {
	    return new OpenAPI()
	        .info(new Info().title("ProgressTrackingService API").version("1.0")
	            .description("ProgressTrackingService Documentation by using Swagger")
	            .contact(new Contact().name("Dmytro Trofimov")
	                .email("dima6836753@gmail.com"))
	            .license(new License().name("Apache 2.0").url("http://springdoc.org")))
	        .servers(List.of(new Server().url("http://localhost:8084").description("Local server"),
